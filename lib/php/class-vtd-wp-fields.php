...
class VTD_WP_Fields {
  ...
  public function upload_input($field) {
    ...
    printf(
        '
        <span class="vtd-wp-fields-uploader">
          %s
  ...
  public function vtd_generate_form_field($fields, $common_attrs = array()) {
    if(!empty($fields)) {
  ...
  public function string_wpml($input) {
    ...
    if (function_exists( 'icl_t' )) {
      return icl_t('VTDesigns', ''.$input.'', ''.$input.'');
    } else {
      return $input;
    }
  }
